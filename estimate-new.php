<?php
(isset($_GET['device'])) ? $device = $_GET['device'] : $device = "notset";
?>
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/estimate.css">
</head>
<script>
    //set device screen size
    if ("<?= $device ?>" == "notset") {
        let device = ((window.screen.width) > 1024) ? "desktop" : "tablet";
        window.location.href = "estimate.php?device=" + device;
    }
</script>
...
<body>
    ...
    <section class="text-center my-2">
        <div>
            <a class="text-light" href="estimate.php?device=tablet">
            ...
            <a class="text-light" href="estimate.php?device=desktop">
                <button class="btn btn-success">
                    <svg width="15" class="view mb-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <section class="container">
        <form method="post">
            ...
            ?>
                <section class="stick flex row m-0">
                    ...
                    <div class="col-6 col-sm-6 col-lg-4 col-xl-1 text-center">
            ...
            <div class="fw-30 py-2">
                <center>
                    <h4 class="pt-15 min mb-0"> Minimum Order Amount Rs : &#8377; <?php echo number_format($site_minimum_order, 2) ?></h4>
                </center>
            </div>
                            ...
                            ?>
                                    <tr>
                                        <td colspan="7" class="fw-20 cat">
                                            <p style="margin:0" id="cat_<?php echo $c_id ?>"><?php echo $category ?> ( <?php echo $discount ? $discount . "% discount" : "Net Price"; ?> )</p>
                                        </td>
                                    ...
                                    while ($items = mysqli_fetch_array($resultitems)) {
                                        ...
                                        $image = ($img == "") ? "assets/img/logo/logo.png" : "admin/dashboard/uploads/" . $img;
                                        $video = ($vid == "") ? "" : "$vid";
                                    ?>
                                        <tr>
                                            <td><img src=<?php echo $image ?> alt="<?php echo $site_name ?>" onclick="showPopUp(<?php echo $id ?>)" /></td>
                                            <td class="code"><?php echo $items['alignment'] ?></td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="flex">
                                                    ...
                                                    <input class="nop inp" type="number" min="1" oninput="calc(<?php echo $id ?>)" id="qty_<?php echo $id ?>" value="" />
                ...
                <section>
                    ...
                    ?>
                            ...
                            <div class="row w-100 m-0">
                                ...
                                ?>
                                    <div class="col-lg-4 col-md-6 col-12 p-0 ps-2 py-2">
                                        <div class="card prdcard <?= $bgcol ?>">
                                            ...
                                            <div class="d-flex justify-content-evenly align-items-center flex-wrap" style="min-height:100px;">
                                                <img class="cimg" src=<?php echo $image ?> alt="<?php echo $site_name ?>" onclick="showPopUp(<?php echo $id ?>)" />
                                                <div class="d-flex">
    ...
    <script>
        ...
        const showPopUp = (id) => {
            ...
            let newDiv = $("<div></div>").addClass("pop").html(
                ...
                <div class="bt-2 pd-10 flex">
                    ...
                    <i class="fa-brands fa-youtube vicon" onclick="change('video')"></i>
                </div>`
            );
            if (video == "") {
                newDiv = $("<div></div>").addClass("pop").html(
                    `<div class="pd-10 fw-20 flex bb-2" style="justify-content: space-between"> 
                        <p>${name}</p>
                        <button class="btn" onclick="closePopUp()">&times;</button>
                    </div>
        ...
        const closePopUp = () => $(".popupsec").hide();
        const change = (value) => {
            if (value == "img") {
